...
const moment = require('moment');////////!BerkayBE__
...
app.get("/", (request, response) => {
  console.log(Date.now() + "FwhyCode !BerkayBE__ Altyapısı");//dokunmayın çalışmaz
  response.sendStatus(200);
});
app.listen(process.env.PORT);
setInterval(() => {
  http.get(`https://!BerkayBE__premium.glitch.me/`);
}, 280000);
    ...
    try {//ukqzn//ukqzn//ukqzn//ukqzn//ukqzn//ukqzn//ukqzn//ukqzn//ukqzn//ukqzn//ukqzn//ukqzn//ukqzn//ukqzn//ukqzn//ukqzn//ukqzn//ukqzn//ukqzn//ukqzn
      ...
      if (!role) {
        ...
        var embed = new Discord.RichEmbed()
          ...
          .setColor("0x36393E")
          .setFooter(`!BerkayBE__ Otorol Sistemi`);//ukqzn//ukqzn//ukqzn//ukqzn//ukqzn//ukqzn//ukqzn//ukqzn//ukqzn//ukqzn//ukqzn
        ...
        var embed = new Discord.RichEmbed()//ukqzn
          ...
          .setFooter(`!BerkayBE__ Otorol Sistemi`);//ukqzn
...
if (!modlogkanal) return;
	if (channel.type === "text") {
				...
				.setFooter(`!BerkayBE__ | MOD-LOG Kanal ID: ${channel.id}`)
...
.setTitle("SES KANALI OLUŞTURULDU")
				...
				.setFooter(`!BerkayBE__ | MOD-LOG Sistemi Kanal ID: ${channel.id}`)
...
client.on("messageDelete", async message => {
  ...
  const embed = new Discord.RichEmbed()
    ...
    .setFooter("!BerkayBE__ | Log Sistemi");
  modlogkanal.sendEmbed(embed);
});
client.on("guildBanAdd", async message => {
  let modlogs = db.get(`tc-modlog_${message.guild.id}`);
...
client.on("channelCreate", async channel => {
  ...
  if (channel.type === "text") {
    let embed = new Discord.RichEmbed()
      .setColor("PURPLE")
      .setDescription(`${channel.name} adlı metin kanalı oluşturuldu.`)
      .setFooter(`!BerkayBE__ | Log Sistemi Kanal ID: ${channel.id}`);
    modlogkanal.send({ embed });
  }
  if (channel.type === "voice") {
    let embed = new Discord.RichEmbed()
